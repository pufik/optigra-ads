...
public class AnonymousApplicationDaoTest {
    ...
    @InjectMocks
    private final AnonymousApplicationDao unit = new AnonymousApplicationDao();
    ...
    public void testGetApplicationById() {
        ...
        Query<Application> query = new Query<Application>(Application.class, Queries.FIND_APPLICATION_BY_ID_FOR_DEVICE.getQuery(), parameters);
